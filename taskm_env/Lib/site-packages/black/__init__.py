...
def spellcheck_pyproject_toml_keys(
    ...
    if invalid_keys:
        ...
        out(f"Invalid config keys detected: {
            keys_str} (in {config_file_path})", fg="red", )
...
def get_sources(
    *,
    ...
    assert root.is_absolute(), f"INTERNAL ERROR: `root` must be absolute but is {
        root}"
