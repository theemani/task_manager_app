    ...
    if (
        ...
        try:
            ...
            if (
                ...
                # the omit optional parens split is preferred by some other
                # reason
...
def bracket_split_succeeded_or_raise(
    ...
    if not body:
        if tail_len == 0:
            ...
            raise CannotSplit(f"Splitting brackets on an empty body to save {
                tail_len} characters is" " not worth it")
...
def bracket_split_build_line(
    ...
    *,
    ...
    if component is _BracketSplitComponent.body:
        ...
        if leaves:
            no_commas = (
                # Ensure a trailing comma for imports and standalone function
                # arguments
                original.is_def
