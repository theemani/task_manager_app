...
class StyleGuideManager:
    ...
    def __init__(
        ...
        self.style_guide_for = functools.lru_cache(
            maxsize=None)(self._style_guide_for)
    ...
    def processing_file(
            self, filename: str) -> Generator[StyleGuide, None, None]:
...
class StyleGuide:
    ...
    def handle_error(
        ...
        error_is_selected = self.should_report_error(
            error.code) is Decision.Selected
