    ...
    class List(list):
        ...
        def __new__(cls, contained=None):
            ...
            if not isinstance(contained, list):
                raise TypeError(f"{cls.__name__} may only be constructed with a list, not {
    ...
    def pop(self, *args, **kwargs):
        ...
        for k, v in kwargs.items():
            if k == "default":
                ...
                raise TypeError(
                    f"pop() got an unexpected keyword argument {
                        k!r}")
        ...
        for i, obj in enumerate(self._toklist):
            if isinstance(obj, ParseResults):
                ...
                for k, v in obj.items():
                    dest[k] = v.deepcopy() if isinstance(
                        v, ParseResults) else v
            elif isinstance(obj, Container):
                self._toklist[i] = type(obj)(
                    v.deepcopy() if isinstance(
                        v, ParseResults) else v for v in obj)
        return ret
    ...
    def from_dict(cls, other, name=None) -> "ParseResults":
        ...
        def is_iterable(obj):
            try:
                ...
                return False
            # str's are iterable, but in pyparsing, we don't want to iterate
            # over them
            else:
